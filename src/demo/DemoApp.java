...
public class DemoApp {
    ...
    public static void main(String[] args) {
        ...
        User user1 = new User("Niharika", "123Abc", "ABC", "address1", 128828);
        User user2 = new User("Shrey", "234Abc", "ABC", "address2", 128828);
        User user3 = new User("Mayank", "897aab", "XYZ", "address3", 128828);
        User user4 = new User("Shail", "423Abc", "ABC", "address1", 128828);
